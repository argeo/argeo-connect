...
public interface ConnectNames {
	...
	public final static String CONNECT_PUBLISHED_DATE = CONNECT_ + "publishedDate";
	...
	/** Connect GPS */
	// Session handling
	public final static String CONNECT_SESSION_NAME = CONNECT_ + "sessionName";
	public final static String CONNECT_SESSION_STATUS = CONNECT_ + "sessionStatus";
	public final static String CONNECT_COMMENTS = CONNECT_ + "comments";
	public final static String CONNECT_DEFAULT_SENSOR_NAME = CONNECT_ + "defaultSensorName";
	...
	public final static String CONNECT_PARAM_DEFAULT_VALUE = CONNECT_ + "paramDefaultValue";
	public final static String CONNECT_PARAM_MIN_VALUE = CONNECT_ + "paramMinValue";
	public final static String CONNECT_PARAM_MAX_VALUE = CONNECT_ + "paramMaxValue";
