...
public class DemoDataImport 
//implements PeopleConstants
{
	...
	// private void createSearch(Session adminSession) throws
	// RepositoryException {
	...
	// }
	//
	// private void createQueryNodeForType(Node queryParentNode, String
	// NodeType,
