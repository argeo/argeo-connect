...
public class MilestoneListPage extends FormPage implements ArgeoNames {
	...
	public MilestoneListPage(FormEditor editor, String id, Node project, UserAdminService userAdminService,
