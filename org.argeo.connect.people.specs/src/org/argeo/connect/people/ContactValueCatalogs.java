...
public class ContactValueCatalogs {
	...
	public static final String[] ARRAY_PERSON_PRIVATE_PHONES = {
			CONTACT_CAT_MOBILE, CONTACT_CAT_DIRECT, CONTACT_CAT_VOIP,
			CONTACT_CAT_FAX, CONTACT_OTHER };
	...
	// Org phones
	public static final String[] ARRAY_ORG_PHONES = { CONTACT_CAT_MAIN,
			CONTACT_CAT_VOIP, CONTACT_CAT_FAX, CONTACT_OTHER };
	...
	public static final String[] ARRAY_PERSON_HOME_ADDRESSES = {
			CONTACT_CAT_MAIN, CONTACT_CAT_SECONDARY, CONTACT_CAT_DELIVERY,
			CONTACT_CAT_INVOICE, CONTACT_OTHER };
	...
	// Social Media
	public static final String[] ARRAY_SOCIAL_MEDIA = { CONTACT_CAT_FACEBOOK,
			CONTACT_CAT_GOOGLEPLUS, CONTACT_CAT_LINKEDIN, CONTACT_CAT_TWITTER,
			CONTACT_CAT_XING, CONTACT_CAT_YOUTUBE, CONTACT_CAT_VIMEO,
			CONTACT_CAT_FLICKR, CONTACT_CAT_FOURSQUARE, CONTACT_CAT_INSTAGRAM,
			CONTACT_OTHER };

	// IMPP
	public static final String[] ARRAY_IMPP = { CONTACT_CAT_SKYPE,
			CONTACT_CAT_MSN, CONTACT_CAT_ICQ, CONTACT_CAT_AIM,
