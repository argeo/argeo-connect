...
public class PeopleJcrUtils implements PeopleNames {
	 ...
	 * </ul>
	 */
	public static boolean markAsPrimary(ResourceService resourceService, PeopleService peopleService, Node parentNode,
			Node primaryChild) {
		try {
			...
			updatePrimaryCache(resourceService, peopleService, parentNode, primaryChild, true);
			return true;
		} catch (RepositoryException re) {
	 ...
	 */
	public static void updatePrimaryCache(ResourceService resourceService, PeopleService peopleService, Node parentNode,
				...
				if (isPrimary) {
					...
					if (primaryChild.isNodeType(PeopleTypes.PEOPLE_CONTACT_REF)
						...
						if (EclipseUiUtils.notEmpty(countryStr))
							countryStr = resourceService.getEncodedTagValue(ConnectJcrUtils.getSession(primaryChild),
	...
	public static Node createContact(PeopleService peopleService, ResourceService resourceService, Node parentNode,
			String nodeType, String name, String value, boolean primary, String nature, String category, String label) {
		return createContact(peopleService, resourceService, parentNode, nodeType, name, value, primary, nature, null,
				category, label);
	}
	...
	public static Node createContact(PeopleService peopleService, ResourceService resourceService, Node parentNode,
		...
		try {
			...
			if (primary)
				markAsPrimary(resourceService, peopleService, parentNode, contact);
	 ...
	 *            an optional label
	 */
	public static Node createEmail(PeopleService peopleService, ResourceService resourceService, Node parentNode,
	 ...
	 * @return
	 */
	public static Node createWebsite(PeopleService peopleService, ResourceService resourceService, Node parentNode,
	...
	public static Node createSocialMedia(PeopleService peopleService, ResourceService resourceService, Node parentNode,
	...
	public static Node createImpp(PeopleService peopleService, ResourceService resourceService, Node parentNode,
			String urlString, boolean primary, String nature, String category, String label) {
	 ...
	 * @return
	 */
	public static Node createPhone(PeopleService peopleService, ResourceService resourceService, Node parentNode,
	 ...
	 * @return
	 */
	public static Node createAddress(PeopleService peopleService, ResourceService resourceService, Node parentNode,
	 ...
	 * @return
	 */
	public static Node createWorkAddress(PeopleService peopleService, ResourceService resourceService, Node parentNode,
