...
public class ContactValueCatalogs {
	...
	public static final String[] ARRAY_PERSON_HOME_ADDRESSES = { CONTACT_NO_VAL, CONTACT_CAT_MAIN,
			CONTACT_CAT_SECONDARY, CONTACT_CAT_DELIVERY, CONTACT_CAT_INVOICE, CONTACT_OTHER };

	// Org adresses
	public static final String[] ARRAY_ORG_ADDRESSES = { CONTACT_NO_VAL, CONTACT_CAT_HEADOFFICE, CONTACT_CAT_SECOFFICE,
			CONTACT_CAT_BILLING, CONTACT_CAT_DELIVERY, CONTACT_CAT_PUBLIC_ENTRANCE, CONTACT_OTHER };
