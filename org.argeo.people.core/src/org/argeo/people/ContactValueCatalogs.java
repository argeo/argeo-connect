...
/**
 * Statically define the known contact types and corresponding default
 * catalogues before we implement a cleaner management of such an issue
 */
public class ContactValueCatalogs {
	...
	public final static String CONTACT_TYPE_MOBILE = "Mobile";
	...
	public final static String CONTACT_TYPE_FAX = "Fax";
	...
	public final static String CONTACT_CAT_STANDARD = "Standard";
	...
	static {
		...
		tmpMap.put(PeopleTypes.PEOPLE_MOBILE, CONTACT_TYPE_MOBILE);
		tmpMap.put(PeopleTypes.PEOPLE_TELEPHONE_NUMBER, CONTACT_TYPE_PHONE);
		...
		tmpMap.put(PeopleTypes.PEOPLE_FAX, CONTACT_TYPE_FAX);
		MAPS_CONTACT_TYPES = Collections.unmodifiableMap(tmpMap);
	}

	// Corresponding array for various lists
	public static final String[] ARRAY_CONTACT_NATURES = { CONTACT_NATURE_PRO, CONTACT_NATURE_PRIVATE };

	public static final String[] ARRAY_CONTACT_TYPES = { CONTACT_TYPE_EMAIL, CONTACT_TYPE_MOBILE, CONTACT_TYPE_PHONE,
			CONTACT_TYPE_ADDRESS, CONTACT_TYPE_SOCIAL_MEDIA, CONTACT_TYPE_URL, CONTACT_TYPE_IMPP, CONTACT_TYPE_FAX };

	// Person private phones
	public static final String[] ARRAY_PERSON_PRIVATE_PHONES = { CONTACT_CAT_HOME, CONTACT_OTHER };

	// Person professional phones
	public static final String[] ARRAY_PERSON_PRO_PHONES = { CONTACT_CAT_DIRECT, CONTACT_CAT_STANDARD, CONTACT_OTHER };

	// Org phones
	public static final String[] ARRAY_ORG_PHONES = { CONTACT_CAT_MAIN, CONTACT_CAT_STANDARD, CONTACT_CAT_VOIP,
			CONTACT_OTHER };

	// Mobile phones
	public static final String[] ARRAY_MOBILES = { CONTACT_CAT_MAIN, CONTACT_OTHER };

	// Fax numbers
	public static final String[] ARRAY_FAXES = { CONTACT_CAT_MAIN, CONTACT_OTHER };

	// Person addresses
	public static final String[] ARRAY_PERSON_WORK_ADDRESSES = { CONTACT_CAT_HEADOFFICE, CONTACT_CAT_SECOFFICE,
			CONTACT_CAT_BILLING, CONTACT_CAT_DELIVERY, CONTACT_CAT_PUBLIC_ENTRANCE, CONTACT_OTHER };

	public static final String[] ARRAY_PERSON_HOME_ADDRESSES = { CONTACT_CAT_MAIN, CONTACT_CAT_SECONDARY,
			CONTACT_CAT_DELIVERY, CONTACT_CAT_INVOICE, CONTACT_OTHER };

	// Org adresses
	public static final String[] ARRAY_ORG_ADDRESSES = { CONTACT_CAT_HEADOFFICE, CONTACT_CAT_SECOFFICE,
			CONTACT_CAT_BILLING, CONTACT_CAT_DELIVERY, CONTACT_CAT_PUBLIC_ENTRANCE, CONTACT_OTHER };

	// Social Media
	public static final String[] ARRAY_SOCIAL_MEDIA = { CONTACT_CAT_FACEBOOK, CONTACT_CAT_GOOGLEPLUS,
			CONTACT_CAT_LINKEDIN, CONTACT_CAT_TWITTER, CONTACT_CAT_XING, CONTACT_CAT_YOUTUBE, CONTACT_CAT_VIMEO,
			CONTACT_CAT_FLICKR, CONTACT_CAT_FOURSQUARE, CONTACT_CAT_INSTAGRAM, CONTACT_OTHER };

	// IMPP
	public static final String[] ARRAY_IMPP = { CONTACT_CAT_SKYPE, CONTACT_CAT_MSN, CONTACT_CAT_ICQ, CONTACT_CAT_AIM,
			CONTACT_CAT_YAHOO, CONTACT_CAT_GOOGLE_TALK, CONTACT_OTHER };
