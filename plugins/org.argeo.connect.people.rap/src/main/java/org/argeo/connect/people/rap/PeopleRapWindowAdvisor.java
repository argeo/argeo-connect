...
public class PeopleRapWindowAdvisor extends RapWindowAdvisor {

	private String username;

	public PeopleRapWindowAdvisor(IWorkbenchWindowConfigurer configurer,
			String username) {
	...
	public ActionBarAdvisor createActionBarAdvisor(
		...
		return new PeopleRapActionBarAdvisor(configurer, username);
	}
