...
public class LinkBrowserPage extends FormPage implements ConnectNames {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		// } catch (SWTError e) {
		// try {
		// IWebBrowser externalBrowser = getSite().getWorkbenchWindow()
		// .getWorkbench().getBrowserSupport()
		// .getExternalBrowser();
		// externalBrowser.openURL(new URL(editorInput.getUrl()));
		// } catch (Exception e1) {
		// throw new ArgeoException("Cannot open browser for "
		// + editorInput.getUrl(), e);
		// }
		// }
