...
public class ChannelEditorCTab {
}
//
...
//
// /**
// * Might be broken. Should be removed.
// *
...
// * </ul>
// */
// public class ChannelEditorCTab extends AbstractEntityCTabEditor implements
// RssNames {
// final static Log log = LogFactory.getLog(ChannelEditorCTab.class);
//
// // local constants
...
// gd.horizontalAlignment = SWT.FILL;
// gd.verticalAlignment = SWT.FILL;
// populateMainInfoDetails(switchingPanel);
//
// // Add a new tag
...
//
// @Override
// protected void populateTitleComposite(final Composite switchingPanel) {
