 ...
 */
public abstract class AbstractEntityTestScrollEditor extends EditorPart
	...
	public void createPartControl(Composite parent) {
		...
		main.setLayout(gridLayoutNoBorder());
		...
		Composite body = toolkit.createComposite(main, SWT.NO_FOCUS);
	...
	private class MyManagedForm extends CompositeManagedForm {
		...
		public void dirtyStateChanged() {
			AbstractEntityTestScrollEditor.this.firePropertyChange(PROP_DIRTY);
		}
		...
		public void commit(boolean onSave) {
			super.commit(onSave);
			if (onSave) {
				AbstractEntityTestScrollEditor.this
