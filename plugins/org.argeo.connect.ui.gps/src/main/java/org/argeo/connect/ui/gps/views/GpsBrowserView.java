...
public class GpsBrowserView extends AbstractJcrBrowser {
	...
	public void createPartControl(Composite parent) {
		...
		col.setLabelProvider(new PropertyColumnLabelProvider());
	...
	private class PropertyColumnLabelProvider extends ColumnLabelProvider {
		public String getText(Object element) {
			try {
