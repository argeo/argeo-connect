...
//
// // "One session per editor" pattern to secure various nodes and
// // changes life cycle
...
// log.warn("This class is deprecated and should not be used. ");
//
// setSite(site);
// setInput(input);
// try {
...
// }
//
// // tries to set this part name
// updatePartName();
//
// // update tooltip
// String displayName = CommonsJcrUtils
// .get(entity, Property.JCR_TITLE);
...
// JcrUtils.discardUnderlyingSessionQuietly(entity);
// // stopEditing();
// notifyCheckOutStateChange();
