...
public class SimpleJcrTableComposite extends Composite {
	 ...
	 * @param addSelection
	 */
	public SimpleJcrTableComposite(Composite parent, int style, Session session, String parentPath, String nodeType,
	...
	public List<Node> getSelectedNodes() {
		if (hasSelectionColumn) {
			Object[] elements = ((CheckboxTableViewer) tableViewer).getCheckedElements();
		...
		if (hasSelectionColumn) {
			...
			SelectionAdapter selectionAdapter = new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {
					...
					((CheckboxTableViewer) tableViewer).setAllChecked(allSelected);
				}
			};
	...
	protected void refreshFilteredList() {
		...
		try {
			...
			throw new ConnectException("Unable to list users", e);
		}
	}
