...
public class PersonEditor extends AbstractPeopleWithImgEditor implements PeopleNames {
	...
	protected void populateHeader(Composite parent) {
		...
		// getResourcesService(),
		// getSystemWorkbenchService(), PeopleTypes.PEOPLE_MAILING_LIST, person,
	...
	protected void populateTitleComposite(Composite parent) {
		...
		// Composite thirdCmp = getFormToolkit().createComposite(editPanelCmp,
		// SWT.NO_FOCUS);
		...
		// Composite fourthCmp = getFormToolkit().createComposite(editPanelCmp,
		// SWT.NO_FOCUS);
		...
		// ConnectWorkbenchUtils.createRDText(getFormToolkit(), firstCmp, "Display
		// name",
		// "Default display name for this person", 300);
		// final Button defineDistinctBtn = getFormToolkit().createButton(firstCmp,
		// "Define a distinct display name",
		// SWT.CHECK);
		// if (!EclipseUiUtils.isEmpty(ConnectJcrUtils.get(person,
		...
		// 80);
		// final Text titleTxt = ConnectWorkbenchUtils.createRDText(getFormToolkit(),
		// thirdCmp, "Title", "Doc., Sir...",
		// 60);
		// final Text maidenNameTxt =
		// ConnectWorkbenchUtils.createRDText(getFormToolkit(), thirdCmp, "Maiden Name",
		// "Birth Name before getting maried", 100);
		// final Text nickNameTxt = ConnectWorkbenchUtils.createRDText(getFormToolkit(),
		// thirdCmp, "Nickame",
		// "A pseudonym...", 100);
		// final Text latinPhoneticTxt =
		// ConnectWorkbenchUtils.createRDText(getFormToolkit(), thirdCmp, "Latin
		// Phonetic",
		// "A helper to know how to pronounce this name", 100);

		// Fourth Line
		// ConnectWorkbenchUtils.createBoldLabel(getFormToolkit(), fourthCmp, "Form Of
		// Address");
		...
		// layout.marginHeight = layout.marginTop = layout.marginBottom =
		...
		//
		// ConnectWorkbenchUtils.createBoldLabel(getFormToolkit(), fourthCmp,
		// "Language");
		...
		// addDNameModifyListener(displayNameTxt, defineDistinctBtn, person,
		// PeopleNames.PEOPLE_DISPLAY_NAME, editPart);
		//
		...
		// String displayName =
		// getPeopleService().getPersonService().getDefaultDisplayName(person);
		// if (defineDistinct) {
		// ConnectJcrUtils.setJcrProperty(person, PeopleNames.PEOPLE_DISPLAY_NAME,
		// PropertyType.STRING,
		// displayName);
		...
		ConnectWorkbenchUtils.addTxtModifyListener(editPart, salutationTxt, person, PEOPLE_SALUTATION,
				PropertyType.STRING);
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, middleNameTxt, person,
		// PEOPLE_MIDDLE_NAME,
		// PropertyType.STRING);
		ConnectWorkbenchUtils.addTxtModifyListener(editPart, lastNameTxt, person, PEOPLE_LAST_NAME,
				PropertyType.STRING);
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, nickNameTxt, person,
		...
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, maidenNameTxt, person,
		// PEOPLE_MAIDEN_NAME,
		// PropertyType.STRING);
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, titleTxt, person,
		// PEOPLE_HONORIFIC_TITLE,
		// PropertyType.STRING);
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, suffixTxt, person,
		// PEOPLE_NAME_SUFFIX,
		// PropertyType.STRING);
		// ConnectWorkbenchUtils.addTxtModifyListener(editPart, latinPhoneticTxt,
		// person, PEOPLE_LATIN_PHONETIC_SPELLING,
		// PropertyType.STRING);
