...
/**
 * FIXME find a better workaround for this problem: Fork the Wizard Dialog to
 * enable the display of a wizard without the empty composite that still stays
 * there when using a wizard with no progress bar.
 * 
 ...
 * </p>
 * <p>
 * Clients may subclass <code>NoProgressBarWizardDialog</code>, although this is
 * rarely required.
 * </p>
 * 
 * @since 1.0
 */
class NoProgressBarWizardDialog extends TitleAreaDialog implements IWizardContainer2, IPageChangeProvider {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4454711006482525481L;
	...
	private Object aboutToStart(boolean enableCancelButton) {
		...
		if (getShell() != null) {
			...
			// if (e.detail == SWT.TRAVERSE_RETURN || (e.detail ==
			// SWT.TRAVERSE_MNEMONIC && e.keyCode == 32)) {
			// // We want to ignore the keystroke when we detect that it has
			...
			// if (timeWhenLastJobFinished != 0 && System.currentTimeMillis() -
